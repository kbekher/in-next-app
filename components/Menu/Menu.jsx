      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <motion.header
              className='w-full text-[var(--color-white)]'
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.4 }}
            >
              <div className="grid grid-cols-2 md:grid-cols-12 px-5 py-4 md:pr-8">
            ...
            {/* Main Content Area */}
            <motion.div
              className="flex-1 flex md:mt-[140px] px-5"
              ...
              <div className="w-full">
                <div className="flex flex-col gap-10 md:grid grid-cols-12 gap-5">
                  ...
                  <div className='col-start-3 col-span-2'>
                    <h3 className="uppercase text-[var(--color-white)] mb-2 md:mb-6">{t("menu.btn")}</h3>
                    <nav>
                      <ul className='flex flex-col justify-center flex-wrap gap-2 md:gap-3 text-[var(--color-gray)]'>
                  ...
                  <div className='col-start-6 col-span-3'>
                    <h3 className="uppercase text-[var(--color-white)] mb-2 md:mb-6">{t("menu.selected-work")}</h3>
                    <ul className="space-y-2 md:space-y-4 text-[var(--color-gray)]">
            ...
            {isMobile && (
              <motion.div
                className='text-[var(--color-white)] px-5 pb-8 text-[16px] fixed bottom-0 w-full'
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.6, duration: 0.4 }}
              >
